...
class Juice:
    ...
    def __add__(self,other):
        return (self.name+"&"+other.name,self.capacity+other.capacity)
...
result = a + b #result return a tuple
oo= Juice(result[0],result[1]) #make another object by tuple components
print(oo)
